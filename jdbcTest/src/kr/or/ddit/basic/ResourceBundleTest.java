...
/*
 *  ResourceBundle객체 =>파일의 확장자가 '.properties'인 내용을 읽어와
 *  	key값과 value 값으로 분리해서 정보를 갖는 객체
 *  	(읽어올 파일의 내용은 'key값=value값' 형태로 작성되어 있어야한다.)
 */
public class ResourceBundleTest {
	...
	public static void main(String[] args) {
		...
		//		=> 읽어올 파일을 지정할떄 '패키지명.파일명'까지만 기입 확장자는 쓰지 않음
		// 		   (이유 : 확장자는 항상 '.properties'이기 때문에...)
		// 객체 생성이 완료되면 파일 내용을 읽어와 저장하는 작업까지 완료한다.
